...
module.exports = {
  eth: {
    ...
    CONTRACT_ADMIN_ADDRESS: process.env.PROJECT_ADMIN_ADDRESS || COAProjectAdmin.networks['5777'].address,
    CONTRACT_ORACLE_ADDRESS: process.env.ORACLE_ADDRESS || COAOracle.networks['5777'].address,
