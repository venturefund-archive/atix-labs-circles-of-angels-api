...
CREATE TYPE role AS ENUM ('entrepreneur', 'funder', 'oracle', 'admin');
...
CREATE TYPE ProjectStatus AS ENUM ('pending', 'consensus', 'ongoing');
...
-- CREATE TYPE fileType AS ENUM ('experience');
