...
const getUser = fastify => async (request, reply) => {
...
const getUserRole = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
  try {
...
const getRegistrationStatus = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
  try {
    fastify.log.info(
...
const getAllRoles = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
  try {
...
const signupUser = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
  try {
...
const updateUser = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
...
const getOracles = fastify => async (request, reply) => {
  const { userService } = apiHelper.helper.services;
...
const recoverPassword = fastify => async (request, reply) => {
  try {
...
const updatePassword = fastify => async (request, reply) => {
  try {
    const { passRecoveryService } = apiHelper.helper.services;
...
const getUserProjects = fastify => async (request, reply) => {
  const {
    userService,
    userProjectService,
    projectService
...
module.exports = fastify => ({
  ...
  getUserRole: getUserRole(fastify),
  getRegistrationStatus: getRegistrationStatus(fastify),
  getAllRoles: getAllRoles(fastify),
  loginUser: loginUser(fastify),
  signupUser: signupUser(fastify),
  updateUser: updateUser(fastify),
  getOracles: getOracles(fastify),
  recoverPassword: recoverPassword(fastify),
  updatePassword: updatePassword(fastify),
  getUserProjects: getUserProjects(fastify)
});
